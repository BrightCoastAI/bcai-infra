...
variable "ssh_key_secret_id" {
  description = "Optional Secret Manager secret ID containing the SSH private key the agent should use for git checkouts. Leave blank to skip installing an SSH key."
  type        = string
  default     = ""
}
